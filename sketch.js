...
function preload() {
	...
	//shop images
	shop1img = loadImage("./img/1.png");
	shop2img = loadImage("./img/2.png");
	shop3img = loadImage("./img/3.png");
	shop4img = loadImage("./img/4.png");
	shop5img = loadImage("./img/5.png");
	shop6img = loadImage("./img/6.png");
	shop7img = loadImage("./img/7.png");
	shop8img = loadImage("./img/8.png");
	shop9img = loadImage("./img/9.png");
	shop10img = loadImage("./img/10.png");
	shop11img = loadImage("./img/11.png");
	shop12img = loadImage("./img/12.png");

	//background of town of game
	bg1img = loadImage("./img/b.jpg");
	bg = loadImage("./ig/bg.jpg");

	// coin images
	coin1img = loadImage("./ig/c1.png");
	coin2img = loadImage("./ig/c2.png");
	coin3img = loadImage("./ig/c3.png");
	coin4img = loadImage("./ig/c4.png");
	coin5img = loadImage("./ig/c5.png");

	//girl and button images
	// girlimg = loadAnimation("./images/g1.png", "images/g2.png");
	// girlstand = loadImage("images/g3.png");
	playbimg = loadImage("./img/b1.png");
	pausebimg = loadImage("./img/b2.png");
	ynimg = loadImage("./i/YN.png");

	//rock and planet images
	rockimg = loadImage("./i/r1.png");
	planet1img = loadImage("./i/p2.png");
	planet2img = loadImage("./i/p3.png");
	planet3img = loadImage("./i/p4.png");
	planet4img = loadImage("./i/p1.png");

	//images
	thoughtimg = loadImage("./i/t1.png");
	resetimg = loadImage("./i/reset1.png");
	nextimg = loadImage("./i/next1.png");
	bubbleimg = loadImage("./img/67.png");
	bg2img = loadImage("./ig/f.jpg");
	bg3img = loadImage("./ig/gmt.jpg");
	message = loadImage("./img/abwelcome.jpg");
    messageimg = loadImage("./i/m1.png");
	footballimg = loadImage("./ig/football.png");
	frogimg = loadImage("./ig/frog.jpg");
	fruitimg = loadImage("./ig/fruit.jpg");
    instrustionimg= loadImage("./i/instrustion.png");
    rulesimg=loadImage("./i/rules.jpg");
	helloimg=loadImage("./i/hello.png");
	crossimg=loadImage("./ig/cross1.png");
	amoungusimg=loadImage("./ig/capsule.jpg");
    pacmanimg=loadImage("./i/pacman.png");
	carRimg=loadImage("./ig/capsule2.jpg");
